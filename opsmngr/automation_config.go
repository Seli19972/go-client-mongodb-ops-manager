...
type Auth struct {
	...
	UsersDeleted             []*MongoDBUserDeleted `json:"usersDeleted"`                       // UsersDeleted are objects that define the authenticated users to be deleted from specified databases or from all databases
...
// MongoDBUserDeleted used in list of deleted users
type MongoDBUserDeleted struct {
